...
const ELEMENT_DATA: PeriodicElement[] = [
  {
    name: 'Ship from location address',
    description: 'ADecTec Delano-ShipFrom',
    Document_Path_URL: 'arcpartographdev.corp.osoftec.com/',
    Updated_Date: '11/8/2020'
  },
  {
    name: 'Ship from location address',
    description: 'ADecTec Delano-ShipFrom',
    Document_Path_URL: 'arcpartographdev.corp.osoftec.com/',
    Updated_Date: '12/8/2020'
  }
