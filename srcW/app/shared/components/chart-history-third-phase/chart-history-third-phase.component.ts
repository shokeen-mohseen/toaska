...
@Component({
  selector: 'app-chart-history-third-phase',
  templateUrl: './chart-history-third-phase.component.html',
  styleUrls: ['./chart-history-third-phase.component.css']
})
export class ChartHistoryThirdPhaseComponent implements OnInit {
