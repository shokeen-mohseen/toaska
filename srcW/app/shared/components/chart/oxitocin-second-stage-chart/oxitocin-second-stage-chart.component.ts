//TFSID 16694  phase - Make the graph responsive.
...
@Component({
  selector: 'app-oxitocin-second-stage-chart',
  templateUrl: './oxitocin-second-stage-chart.component.html',
  styleUrls: ['./oxitocin-second-stage-chart.component.css']
})
export class OxitocinSecondStageChartComponent implements OnInit {
