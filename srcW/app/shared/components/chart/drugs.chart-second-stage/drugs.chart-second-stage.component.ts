...
@Component({
  selector: 'app-drugs-chart-second-stage',
  templateUrl: './drugs.chart-second-stage.component.html',
  styleUrls: ['./drugs.chart-second-stage.component.css']
})
export class DrugsChartSecondStageComponent implements OnInit {
