...
@Component({
  selector: 'app-pulsebp-third-stage-chart',
  templateUrl: './pulsebp-third-stage-chart.component.html',
  styleUrls: ['./pulsebp-third-stage-chart.component.css']
})
export class PulsebpThirdStageChartComponent implements OnInit {
  currentUser: User;
  @ViewChild('PulseBPchart2', { static: true }) chartContainer: ElementRef;
  ...
  constructor(private toastr: ToastrService, private chartinputservice: ChartInputService, private authenticationService: AuthService, private data: DataService, public modalService: NgbModal, public timeConverService: XAxisTimeConversionService) {
    ...
    this.baseGraphViewModel.StagesId = 4;
  ...
  CreateChart(pulseDatasetArray: any, bpDatasetArray: any) {
    ...
    svg.append("line").attr("transform", "translate(-90, 185)")
      ...
      .attr("stroke-width", 1)
      .attr("stroke", "black")
      .attr("marker-end", "url(#triangle9)")
      .attr("marker-start", "url(#triangle8)");
  ...
  openModal() {
    ...
    if (this.chartTimeCalculation.isTimeExceed === 0) {
      ...
      this.modalPopupData.modelStagename = 'key_3rdStageLabour';
      this.modalPopupData.stageId = 4;
      ...
      this.modalRef.componentInstance.passBackPulse.subscribe((receivedEntry) => {
        ...
        this.inputChartServer.StagesID = 4;
      ...
      this.modalRef.componentInstance.passBackBP.subscribe((receivedEntry) => {
        ...
        this.inputChartServer.XAxisPosition = Number(plottingXBP);
