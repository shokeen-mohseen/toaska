...
@Component({
  selector: 'app-pulsebp-second-stage-chart',
  templateUrl: './pulsebp-second-stage-chart.component.html',
  styleUrls: ['./pulsebp-second-stage-chart.component.css']
})
export class PulsebpSecondStageChartComponent implements OnInit {
  currentUser: User;
  @ViewChild('PulseBPchart1', { static: true }) chartContainer: ElementRef;
  ...
  chartMode: string; inputChartServer: ServerChartValues; baseGraphViewModel: BaseChartViewModel;
  ...
  CreateChart(pulseDatasetArray: any, bpDatasetArray: any) {
    ...
    svg.append("line").attr("transform", "translate(-90, 185)")
      ...
      .attr("stroke-width", 1)
      .attr("stroke", "black")
      .attr("marker-end", "url(#triangleC)")
      .attr("marker-start", "url(#triangleC1)");
