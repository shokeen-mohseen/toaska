...
@Component({
  selector: 'app-temperature-fourth-stage-chart',
  templateUrl: './temperature-fourth-stage-chart.component.html',
  styleUrls: ['./temperature-fourth-stage-chart.component.css']
})
export class TemperatureFourthStageChartComponent implements OnInit {
  currentUser: User;
  @ViewChild('chart3', { static: true }) chartContainer: ElementRef;
