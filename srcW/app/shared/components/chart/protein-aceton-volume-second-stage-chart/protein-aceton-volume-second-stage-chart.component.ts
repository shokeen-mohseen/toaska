...
@Component({
  selector: 'app-protein-aceton-volume-second-stage-chart',
  templateUrl: './protein-aceton-volume-second-stage-chart.component.html',
  styleUrls: ['./protein-aceton-volume-second-stage-chart.component.css']
})

export class ProteinAcetonVolumeSecondStageChartComponent implements OnInit {
  currentUser: User; inputChartServer: ServerChartValues;
  @ViewChild('chartProtein1', { static: true }) chartProteinContainer: ElementRef;
  @ViewChild('chartAcetone1', { static: true }) chartAcetoneContainer: ElementRef;
  @ViewChild('chartVolume1', { static: true }) chartVolumeContainer: ElementRef;
  ...
  openModal(modalKey: string) {
    ...
    if (this.chartTimeCalculation.isTimeExceed === 0) {
      ...
      if (modalKey == "partographChart.key_ProtienChart") {
        ...
        this.objProtein.modelStagename = 'key_SecondStageLabour';
        this.objProtein.selectList = this.objProtein.selectList;
        this.objProtein.stageId = 3;
      ...
      // TFSID 16635, Rizwan Khan, 27 July 2020, Add time with timezone
        ...
        this.objAceton.modelStagename = 'key_SecondStageLabour';
        this.objAceton.stageId = 3;
        ...
        this.objVolume.modelStagename = 'key_SecondStageLabour';
        this.objVolume.stageId = 3;
        this.modalRef = this.modalService.open(TempProteinVolumeAcetonChartPopupComponent, { size: 'xl', backdrop: 'static' });
