...
export class MaterialDailyListComponent implements OnInit {
  ...
  displayedColumnsReplace = ['selectRow', 'key_Date', 'key_Sequencenu', 'key_Activitytype', 'key_OrderNo', 'key_Reservation', 'key_Unusedcustomer', 'key_Unusedreservationfromothers', 'key_Reservationavl', 'key_Inventoryavailability', 'key_Actqunt', 'key_Assigned', 'key_Endinginventory','key_Endinginventory'];
