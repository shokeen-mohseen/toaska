...
const ELEMENT_DATA: PeriodicElement[] = [
  { LocationDescription: '', MaterialDescription: '', ReservationAmount: '', OrderQuantity: '', RemainingReservation: '', ReservationAmountA: '', OrderQuantityA: '', RemainingReservationA: '' },
];
...
export class CustomerReportsComponent implements OnInit {
  ...
  displayedColumns = ['LocationDescription', 'MaterialDescription', 'ReservationAmount', 'OrderQuantity', 'RemainingReservation', 'ReservationAmountA', 'OrderQuantityA', 'RemainingReservationA'];
