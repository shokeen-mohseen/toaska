...
@Component({
  selector: 'app-add-organization-label',
  templateUrl: './add-organization-label.component.html',
  styleUrls: ['./add-organization-label.component.css']
})
export class AddOrganizationLabelComponent implements OnInit {
