...
@Component({
  selector: 'app-add-operating-location',
  templateUrl: './add-operating-location.component.html',
  styleUrls: ['./add-operating-location.component.css']
})
export class AddOperatingLocationComponent implements OnInit {
