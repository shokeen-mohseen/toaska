...
@Component({
  selector: 'app-dcinventory-levels',
  templateUrl: './dcinventory-levels.component.html',
  styleUrls: ['./dcinventory-levels.component.css']
})
export class DCInventoryLevelsComponent implements OnInit {
