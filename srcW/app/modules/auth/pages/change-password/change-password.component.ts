...
export class ChangePasswordComponent implements OnInit {
  ...
  ChangePassword() {
    ...
    if (this.f.usernewpassword.value != this.f.userconfirmpassword.value) {
      this.toastrService.error('New Password and Confirm Password not matching');
      this.isLoading = false;
      return;
    }
      ...
      .subscribe(
        data => {
          ...
          if (response) {
              ...
              .subscribe(
                res => {
                  ...
                  if (response2) {
                    ...
                    this.toastrService.success('Password is change successfully');
                    this.isLoading = false;
            ...
            this.toastrService.error('Current Password is Invalid');
            this.isLoading = false;
            return false;
          }
