...
import { AddeditMicroIndicatorDetailComponent } from '../addedit-micro-indicator-detail/addedit-micro-indicator-detail.component';
...
@Component({
  selector: 'app-edit-micro-indicator',
  templateUrl: './edit-micro-indicator.component.html',
  styleUrls: ['./edit-micro-indicator.component.css']
})
export class EditMicroIndicatorComponent implements OnInit {
  ...
  addDetail() {
    this.modalRef = this.modalService.open(AddeditMicroIndicatorDetailComponent, { size: 'xl', backdrop: 'static' });
  }
