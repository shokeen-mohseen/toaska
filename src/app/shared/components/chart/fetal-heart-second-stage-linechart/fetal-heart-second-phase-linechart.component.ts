...
@Component({
  selector: 'app-fetal-heart-second-phase-linechart',
  templateUrl: './fetal-heart-second-phase-linechart.component.html',
  styleUrls: ['./fetal-heart-second-phase-linechart.component.css'],
})

export class FetalHeartSecondPhaseLinechartComponent implements OnInit {
  ...
  // Fetal Heart API
  LoadFetalHeartRateData(baseview) {
