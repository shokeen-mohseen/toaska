...
@Component({
  selector: 'app-tempproteinvolumeacetonchart',
  templateUrl: './temp.protein.volume.aceton.chart.component.html',
  styleUrls: ['./temp.protein.volume.aceton.chart.component.css']
})

export class TempProteinVolumeAcetonChartComponent implements OnInit {
  ...
  openModal(modalKey: string) {
    ...
    if (this.chartTimeCalculation.isTimeExceed === 0) {
      ...
      if (modalKey == "partographChart.key_ProtienChart") {
        ...
        this.objProtein.modelStagename = 'key_LatentPhase';
        this.objProtein.selectList = this.objProtein.selectList;
        this.objProtein.stageId = 1;
      ...
      // TFSID 16635, Rizwan Khan, 27 July 2020, Add time with timezone
        ...
        this.objAceton.modelStagename = 'key_LatentPhase';
        this.objAceton.selectList = this.objAceton.selectList;
        this.objAceton.stageId = 1;
        this.modalRef = this.modalService.open(TempProteinVolumeAcetonChartPopupComponent, { size: 'xl', backdrop: 'static' });
        ...
        this.objVolume.modelName = modalKey;
        this.objVolume.modelStagename = 'key_LatentPhase';
        this.objVolume.stageId = 1;
        this.modalRef = this.modalService.open(TempProteinVolumeAcetonChartPopupComponent, { size: 'xl', backdrop: 'static' });
      ...
      this.modalRef.componentInstance.passProteinEntry.subscribe((receivedEntry) => {
        ...
        //this.inputChartServer.ChartValue = this.chartTimeCalculation.xAxisInterval_Sys.toString();
        ...
        //this.inputChartServer.Y_axis_Position = receivedEntry.selectList.toString(); //receivedEntry.value.toString();
        //this.inputChartServer.UpdateDateTimeBrowser = new Date(this.chartTimeCalculation.observationStartTime);
        //this.inputChartServer.CreateDateTimeBrowser = new Date(this.chartTimeCalculation.observationStartTime);
      ...
      this.modalRef.componentInstance.passAcetoneEntry.subscribe((receivedEntry) => {
        ...
        this.inputChartServer.ChartValue = receivedEntry.selectList;//this.chartTimeCalculation.xAxisInterval_Sys.toString();
        this.inputChartServer.XAxisPosition = this.chartTimeCalculation.xAxisInterval_Sys; //this.chartTimeCalculation.xAxisPulseBp.toString();
        this.inputChartServer.YAxisPosition = 0;//Number(receivedEntry.selectList);// + "" + receivedEntry.TemperatureType; //receivedEntry.value.toString();
        this.inputChartServer.UpdateDateTimeBrowser = new Date(this.chartTimeCalculation.observationStartTime);
        this.inputChartServer.CreateDateTimeBrowser = new Date(this.chartTimeCalculation.observationStartTime);
        ...
        //this.inputChartServer.ChartValue = this.chartTimeCalculation.xAxisInterval_Sys.toString();
        //this.inputChartServer.X_axis_Position = this.chartTimeCalculation.xAxisInterval_Sys.toString(); //this.chartTimeCalculation.xAxisPulseBp.toString();
        //this.inputChartServer.Y_axis_Position = receivedEntry.selectList.toString();
        //this.inputChartServer.UpdateDateTimeBrowser = new Date(this.chartTimeCalculation.observationStartTime);
        //this.inputChartServer.CreateDateTimeBrowser = new Date(this.chartTimeCalculation.observationStartTime);
