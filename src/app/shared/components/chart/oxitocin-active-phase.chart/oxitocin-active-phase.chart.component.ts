...
@Component({
  selector: 'app-oxitocin-active-phasechart',
  templateUrl: './oxitocin-active-phase.chart.component.html',
  styleUrls: ['./oxitocin-active-phase.chart.component.css']
})
export class OxitocinActivePhaseChartComponent implements OnInit {
