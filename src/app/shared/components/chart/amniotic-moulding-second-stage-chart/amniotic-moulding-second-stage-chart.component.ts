...
@Component({
  selector: 'app-amniotic-moulding-second-stage-chart',
  templateUrl: './amniotic-moulding-second-stage-chart.component.html',
  styleUrls: ['./amniotic-moulding-second-stage-chart.component.css']
})
export class AmnioticMouldingSecondStageChartComponent implements OnInit {
  inputChartServer: ServerChartValues; baseGraphViewModel: BaseChartViewModel;
  @ViewChild('chartAmniotic1', { static: true }) chartAmnioticContainer: ElementRef;
  @ViewChild('chartMoulding1', { static: true }) chartMouldingContainer: ElementRef;
  ...
  openModalAmniotic(): void {
    ...
    if (this.chartTimeCalculation.isTimeExceed === 0) {
      ...
      this.modalPopupDatafor_Amniotic.stageId = 3;
      this.modalPopupDatafor_Amniotic.modelName = 'partographChart.Key_AmnioticChart'
      this.modalPopupDatafor_Amniotic.modelStagename = 'key_SecondStageLabour'
  ...
  openModalMoulding(): void {
    ...
    if (this.chartTimeCalculation.isTimeExceed === 0) {
      ...
      this.modalPopupDatafor_Moulding.stageId = 3;
      this.modalPopupDatafor_Moulding.modelName = 'partographChart.Key_MouldingChart';
      this.modalPopupDatafor_Moulding.modelStagename = 'key_SecondStageLabour';
