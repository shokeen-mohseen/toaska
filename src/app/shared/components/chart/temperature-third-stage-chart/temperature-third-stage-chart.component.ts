...
@Component({
  selector: 'app-temperature-third-stage-chart',
  templateUrl: './temperature-third-stage-chart.component.html',
  styleUrls: ['./temperature-third-stage-chart.component.css']
})
export class TemperatureThirdStageChartComponent implements OnInit {
  currentUser: User;
