...
@Component({
  selector: 'app-amniotic-mouldingchart',
  templateUrl: './amniotic-mouldingchart.component.html',
  styleUrls: ['./amniotic-mouldingchart.component.css']
})
export class AmnioticMouldingchartComponent implements OnInit {
  ...
  LoadAmnioticData(baseview) {
    this.chartinputservice.GetAmnioticFluidAnalytics(baseview).subscribe(data => {
      //console.log("sdds " + JSON.stringify(data))
      //console.log("sdds111 " + JSON.stringify(data.data))
  ...
  openModalAmniotic(): void {
    ...
    if (this.chartTimeCalculation.isTimeExceed === 0) {
      ...
      this.modalPopupDatafor_Amniotic.stageId = 1;
      this.modalPopupDatafor_Amniotic.modelName = 'partographChart.Key_AmnioticChart'
      this.modalPopupDatafor_Amniotic.modelStagename = 'key_LatentPhase'
  ...
  openModalMoulding(): void {
    ...
    if (this.chartTimeCalculation.isTimeExceed === 0) {
      ...
      this.modalPopupDatafor_Moulding.stageId = 1;
      this.modalPopupDatafor_Moulding.modelName = 'partographChart.Key_MouldingChart';
      this.modalPopupDatafor_Moulding.modelStagename = 'key_LatentPhase';
