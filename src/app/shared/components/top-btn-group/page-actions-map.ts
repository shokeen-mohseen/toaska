...
const actionItemsTypeMap = {
  ...
  importforecast: {
    label: 'key_Import', colorClass: 'btn-outline-success', iconClass: 'fa fa-file-excel-o', type: 'importforecast', menu: [
      { label: 'key_ManageForecastImport', iconClass: 'fa fa-file-excel-o', type: 'ManageMarketForecastImport' },
  ...
  MapComputation: { label: 'key_MapRateType', colorClass: 'btn-outline-success', iconClass: 'fa fa-plus-square', type: 'MapComputation' },
  ...
  addForecast: {
    label: 'key_Addnew', colorClass: 'btn-outline-primary', iconClass: 'fa fa-plus', type: 'addForecast', menu: [
      { label: 'key_CreatesNewForecast', iconClass: 'fa fa-plus-square-o', type: 'createsNewForecast' },
      { label: 'key_UploadForecast', iconClass: 'fa fa-cloud-upload', type: 'uploadForecast' }
    ]
  },
  addNewRole: { label: 'key_AddNewRole', colorClass: 'btn-outline-primary', iconClass: 'fa fa-plus', type: 'addNewRole' },
  operationalExport: { label: 'key_OperationalExport', colorClass: 'btn-outline-success', iconClass: 'fa fa-file-excel-o', type: 'operationalExport' }
}
...
export function getGlobalRibbonActions(): ActionGroupTab[] {
  return [
    {
      label: 'key_Home',
      actionGroups: getActionGroups('workBench,back,add,addForecast,addRow,regularOrder,bulkOrder,edit,copy,showDetails,invoice,deleteSelectedRow,deleteSelectedForecast,updateContract,save,saveAndNotify,homeCancel,delete,refresh|issue,notification,setupWizard,language,alerts,profile,share,feedback'),      
    },
    {
      label: 'key_Data',
      actionGroups: getActionGroups('import,filter,void,duplicateForecast,importforecast,exportTransplaceTemplate,importTransplaceTemplate,export,operationalExport|share')
    },
    {
      label: 'key_Action',
      actionGroups: getActionGroups('approve,declined,accept,active,inactive,lock,unlock,resetPassword,edittype,addnewtype,addNewRole,orderCancel,flex,AdjustFinalForecast,updateForecast,publish,mapping,tender,ship,receive,approveAndMas,resendToMas,calculate,shipWith,recurrence,cancel,tonu,document,chargeType,ChargeCategory,MapComputation,compute,associate|share')
    },
    {
      label: 'key_View',
      actionGroups: getActionGroups('view,graph,viewForecastAs|share')
    }
