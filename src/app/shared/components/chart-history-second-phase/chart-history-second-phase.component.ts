...
@Component({
  selector: 'app-chart-history-second-phase',
  templateUrl: './chart-history-second-phase.component.html',
  styleUrls: ['./chart-history-second-phase.component.css']
})
export class ChartHistorySecondPhaseComponent implements OnInit {
