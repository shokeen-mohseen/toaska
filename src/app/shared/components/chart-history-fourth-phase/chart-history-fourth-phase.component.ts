...
@Component({
  selector: 'app-chart-history-fourth-phase',
  templateUrl: './chart-history-fourth-phase.component.html',
  styleUrls: ['./chart-history-fourth-phase.component.css']
})
export class ChartHistoryFourthPhaseComponent implements OnInit {
