    ...
    this.inventoryService.GetAllCurrentMaterialOnhand(this.paginationModel)
      .subscribe(result => {
        ...
        result.data.forEach((value, index) => {
          this.Data.push({
            amount: value.amount,
            amountUOMID: value.amountUOMID,
            clientID: value.clientID,
            comment: value.comment,
            createDateTimeBrowser: value.createDateTimeBrowser,
            createDateTimeServer: value.createDateTimeServer,
            createdBy: value.createdBy,
            filterOn: value.filterOn,
            id: value.id,
            ...
            quantityUOMID: value.quantityUOMID,
            //referenceNo: value.referenceNo,
            //responseMessage: value.responseMessage,
            //responseMessageCode: value.responseMessageCode,
            sortColumn: value.sortColumn,
            sortOrder: value.sortOrder,
            sourceSystemID: value.sourceSystemID,
            status: value.status,
            uom: value.uom,
            updateDateTimeBrowser: value.updateDateTimeBrowser,
            //updateDateTimeServer: value.updateDateTimeServer,
            updateDateTimeServer: value.updateDateTimeServer == null ? "" : this.inventoryService.getLocalDateTime(value.updateDateTimeServer),
