...
@Component({
  selector: 'app-partograph-monitoring',
  templateUrl: './partograph-monitoring.component.html',
  styleUrls: ['./partograph-monitoring.component.css']
})
export class PartographMonitoringComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.btnStatus.btnSave = false;
    this.btnStatus.previousPage = '/manage-partograph/new-partograph/prepartum-care';
