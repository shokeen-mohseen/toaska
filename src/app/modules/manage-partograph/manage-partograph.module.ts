...
@NgModule({
  declarations: [NewPartographComponent,
    ...
    ContactInformationComponent, ObstetricFormulaComponent,
    ...
    DischargeReportComponent, AddHospitalComponent, EditHospitalComponent, AddStaffComponent, EditStaffComponent,
    AddPatientComponent,
    ...
    Examination2Component, AddUnitDetailComponent, AddStaffRoleComponent],
  imports: [
