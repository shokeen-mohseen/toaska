...
export class EditMaterialComponent implements OnInit {
  ...
  setMaterialDetails(index: number) {
    ...
    this.selectedMaterialToEdit.updateDateTimeServer = this.materialService.getLocalDateTime(this.convertDatetoStringDate(new Date(nextResult.updateDateTimeServer)));
