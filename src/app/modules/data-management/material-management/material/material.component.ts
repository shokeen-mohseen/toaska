...
export class MaterialComponent implements OnInit, AfterViewInit {
  ...
  actionGroupConfig;
  MaterialList: string = "MaterialExport";
  ...
  @ViewChild(MaterialListComponent) materialListComponent: MaterialListComponent;
        ...
        if (res.Message == "Success") {
          ...
          if (data != null || data != undefined) {
            if (!data || data[0].PermissionType == "Read and Modify") {
              ...
              this.materialService.permission = true;
            }
            else {
              //this.btnBar.disableAction('add');
              ...
              this.materialService.permission = false;
            }
          }
          else {
