  ...
  getExcelUploadDatails() {
    this.freightLaneService.getExcelUploadDetails(this.authenticationService.currentUserValue.LoginId)
      .subscribe(result => {
        ...
        this.lastImportUserDetails.updateDateTimeBrowser = this.freightLaneService.getLocalDateTimeFromDateObject(this.lastImportUserDetails.updateDateTimeBrowser);
      });
  }
