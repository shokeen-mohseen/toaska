        ...
        if (res.message == "Success") {
          res.data.forEach((value, index) => {
            this.Data.push({
              ...
              Approved_Datetime: this.datepipe.transform(value.approved_Datetime == null ? "" : this.contractService.getLocalDateTime(value.approved_Datetime), 'MM/dd/yyyy hh:mm a'),
              IsSelected: false
            });
          })
