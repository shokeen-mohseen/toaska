...
/*  onResizeEnd(event: ResizeEvent, columnName): void {
  ...
  displayedColumnsReplace = ['selectRow', 'key_Group', 'key_BillingEntity', 'key_Shipto', 'key_Citystate', 'key_Customercode', 'key_MASInventoryWarehouse', 'key_Status', 'key_SetupDone', 'key_Setupdate', 'key_Lastupdated'];
  ...
  async ngOnInit() {
    ...
    this.dataSource = new MatTableDataSource<CustomerByLocation>();
