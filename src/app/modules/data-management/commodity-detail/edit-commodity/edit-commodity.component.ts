...
export class EditCommodityComponent implements OnInit {
  ...
  setCommodityDetails(index: number) {
    ...
    this.commodityeditmodel.updateDateTimeBrowser = this.commodityService.getLocalDateTime(this.convertDatetoStringDate(new Date(nextResult.updateDateTimeBrowser)));
  }
