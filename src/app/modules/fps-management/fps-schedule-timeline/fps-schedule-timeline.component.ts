...
@Component({
  selector: 'app-fps-schedule-timeline',
  templateUrl: './fps-schedule-timeline.component.html',
  styleUrls: ['./fps-schedule-timeline.component.css']
})
export class FPSScheduleTimelineComponent implements OnInit {
