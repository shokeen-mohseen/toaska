...
@Component({
  selector: 'app-module-role-permissions',
  templateUrl: './module-role-permissions.component.html',
  styleUrls: ['./module-role-permissions.component.css']
})
export class ModuleRolePermissionsComponent implements OnInit, AfterViewInit {
  modalRef: NgbModalRef;
  @ViewChild('btnBar') btnBar: TopBtnGroupComponent;
  actionGroupConfig;
  ModuleList: string = "ModuleRoleExport";
  ...
  actionHandler(type) {
    if (type === "add") {
      ...
      this.modalRef = this.modalService.open(AddNewRoleComponent, { size: 'lg', backdrop: 'static' });
    }
  ...
  ngAfterViewInit() {
    ...
    this.btnBar.showAction('addNewRole');
