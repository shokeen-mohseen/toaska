...
export class EditFuelsurchargeComponent implements OnInit {
  ...
  submit(formGroup: FormGroup, moveNext = false) {
    if (formGroup.valid) {
      ...
      this.selectedFuelChargeToEdit.updateDateTimeBrowserStr = this.convertDatetoStringDate(new Date());
      ...
      const reqBody = {
        ...
        UpdateDateTimeBrowserStr: this.convertDatetoStringDate(new Date())
      }
