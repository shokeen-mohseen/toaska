...
import { PreferenceTypeService, AuthService } from '../../../../core';
import { Geolocation } from '../models/geolocation';

@Injectable({
  providedIn: 'root'
})
export class GeolocationMappedService extends BaseService {
  ...
  PostGeolocation(mobject: Geolocation) {
    mobject.sourceSystemID = this.authenticationService.currentUserValue.SourceSystemID;
    mobject.createdBy = this.authenticationService.currentUserValue.LoginId;
    mobject.clientId = this.authenticationService.currentUserValue.ClientId;
