...
@Component({
  selector: 'app-add-micro-indicator',
  templateUrl: './add-micro-indicator.component.html',
  styleUrls: ['./add-micro-indicator.component.css']
})
export class AddMicroIndicatorComponent implements OnInit {
