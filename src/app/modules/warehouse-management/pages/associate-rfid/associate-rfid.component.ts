...
@Component({
  selector: 'app-associate-rfid',
  templateUrl: './associate-rfid.component.html',
  styleUrls: ['./associate-rfid.component.css']
})
export class AssociateRfidComponent implements OnInit, AfterViewInit {
