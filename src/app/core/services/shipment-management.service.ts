...
export class shipmentManagementService extends BaseService {
  ...
  public ShipmentsforEditHistory: any = [];
  public ShipmentforEditOrdersHistory: any = [];
  public EditingShipmentHistory: any;
  public EditingShipmentIDHistory: any;
  public EditingVersionHistory: any;
  public LocationsDataHistory: any = [];
  public OrderTypeHistory: string;
  public SelectTabHistory: string;
  ...
  GetChargeType(apchargeBusinessPartnerID, apchargeChargeType, shipmentID) {
    var RequestObject = {
  ...
  GetAllShipmentDetailsHistory(paginationModel: shipmentworkbenchModel) {
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetShipmentDetailsAllHistory`,
      paginationModel)
      .pipe(map(salesOrder => {
        return salesOrder;
      }));
  ...
  GetShipmentDetailsHistory(ShipmentID: number) {
    ...
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetShipmentDetailsHistory`, RequestObject)
      .pipe(map(data => {
        return data;
      }));
  }
  ...
  GetShipmentSalesOrdersHistory(ShipmentID: number) {
    ...
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetShipmentSalesOrdersHistory`, RequestObject)
      .pipe(map(data => {
        return data;
      }));
  }

  GetShipmentSalesOrderDetailsHistory(ShipmentID: number) {
    var RequestObject = {
      ShipmentID: ShipmentID
    };
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetShipmentSalesOrdersDetailsHistory`, RequestObject)
      .pipe(map(data => {
        console.log(data);
        return data;
      }));
  ...
  GetShipmentOrderDetailsforSIDHistory(ShipmentID: number) {
    var RequestObject = {
      ShipmentID: ShipmentID
    };
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetShipmentOrdersDetailsForShipmentIdHistory`, RequestObject)
      .pipe(map(data => {
        console.log(data)
        return data;
      }));
  ...
  GetApchargesHistory(ShipmentID: number) {
    ...
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetApchargesHistory`, RequestObject)
      .pipe(map(data => {
  ...
  GetStatusTrackingHistory(ShipmentID: number) {
    ...
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetShipmentStatusTrackingHistory`, RequestObject)
      .pipe(map(data => {
        return data;
      }));
  }
  ...
  GetTenderStatusTrackingHistory(ShipmentID: number) {
    ...
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/GetShipmentTenderStatusTrackingHistory`, RequestObject)
      .pipe(map(data => {
        return data;
      }));
  }
  ...
  duplicateOriginOfGoods(OriginOfGoods: OriginOfGoods) {
    return this.http.post<any>(`${environment.coreBaseApiUrl}/CountryOfOriginOfMaterial/CheckDuplicate`, OriginOfGoods, this.httpOptions)
      .pipe(map(response => {
        return response;
      }));
  }
  OriginOfGoodsPercentage(OriginOfGoods: OriginOfGoods) {
    return this.http.post<any>(`${environment.coreBaseApiUrl}/CountryOfOriginOfMaterial/PercentageCalculation`, OriginOfGoods, this.httpOptions)
      .pipe(map(response => {
        return response;
      }));
  }
  ...
  ApproveandSendShipmentForMASMultiple(shipmentIDs: string) {
    var RequestObject = {
      ShipmentIDs: shipmentIDs
    };
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/ApproveSendShipmentToMASMultiple`, RequestObject)
      .pipe(map(orderDetails => {
        return orderDetails;
      }));
  }
  ...
  ReSendShipmentForMASMultiple(shipmentIDs: string) {
    var RequestObject = {
      ShipmentIDs: shipmentIDs
    };
    return this.http.post<any>(`${environment.coreBaseApiUrl}/shipment/ReSendShipmentToMASMultiple`, RequestObject)
      .pipe(map(orderDetails => {
        return orderDetails;
      }));
  }
