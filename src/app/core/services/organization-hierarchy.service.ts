...
export class OrganizationHierarchyService {
  ...
  GetOrganizationwithoutCarrier(organizationHierarchy: OrganizationHierarchy) {

    return this.http.post<any>(BASE_URL + '/Organization/GetOrganizationWithoutCarrier', organizationHierarchy)
      .pipe(map(LocationList => {
        return LocationList;
      }));
  }
