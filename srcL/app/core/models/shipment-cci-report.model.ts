export class ShipmentCciReportShipment {
  shipmentId: number;
  ...
  shippmentCciOrderDetails: ShipmentCciOrderDetail[];
}

export class ShipmentCciOrderDetail {
  id: number;
  noOfPackages: string;
...
export class ShipmentCciLocationInfo {
  locationId: number;
  name: string;
  address: string;
  cityState: string;
