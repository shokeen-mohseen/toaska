...
export class GlobalConstants {
  ...
  //order success and Notify
  public static OrderSuccessAndNotify: string = "Order saved and notification sent successfully.";

  //public static OrderCancelSuccessfully: string = "Order cancel successfully.";
  //public static OrderDeletedSuccessfully: string = "Order deleted successfully.";
  //public static SelectOrderToCancel: string = "Please select the order first to cancel it.";
  //public static SelectOrderToDelete: string = "Please select the order first to delete it.";
  //public static ScheduledShipDatecannotbegreaterthenRequestDeliveryDate: string = "Scheduled ShipDate can not be greater then Request Delivery Date.";
  //public static SelectOrderToCopyOrder: string = "Please select the order first then you will able to Copy order.";
  //public static CopyOrderSuccessfully: string = "Copy order successfully.";
  //public static SelectOrderToSendOrderToMAS: string = "Please select the order first then you will able to send order to MAS.";
  //public static RequestHasBeenSendToMASSuccessfully: string = "Your request has been send to MAS Successfully.";
  //public static SelectOrderToReSendOrderToMAS: string = "Please select the order first then you will able to Resend order to MAS.";
  //public static RequestHasBeenReSendToMASSuccessfully: string = "Your request has been Re-send to MAS Successfully.";
  //public static OrderRecalculatedSuccessfully: string = "Order recalculated successfully.";
