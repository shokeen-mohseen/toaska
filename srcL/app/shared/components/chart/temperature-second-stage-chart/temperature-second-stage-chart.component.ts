...
@Component({
  selector: 'app-temperature-second-stage-chart',
  templateUrl: './temperature-second-stage-chart.component.html',
  styleUrls: ['./temperature-second-stage-chart.component.css']
})
export class TemperatureSecondStageChartComponent implements OnInit {
  currentUser: User;
  @ViewChild('chart1', { static: true }) chartContainer: ElementRef;
