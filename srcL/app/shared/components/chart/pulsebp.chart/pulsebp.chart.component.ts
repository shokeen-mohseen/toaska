...
@Component({
  selector: 'app-pulsebpchart',
  templateUrl: './pulsebp.chart.component.html',
  styleUrls: ['./pulsebp.chart.component.css']
})
export class PulsebpChartComponent implements OnInit {
  currentUser: User;
  @ViewChild('PulseBPchart', { static: true }) chartContainer: ElementRef;
