...
import { ServerChartCommonComment, ServerChartValues } from '@app/modules/manage-partograph/modals/input-chart';
...
@Component({
  selector: 'app-fetal-heart-linechart',
  templateUrl: './fetal-heart-linechart.component.html',
  styleUrls: ['./fetal-heart-linechart.component.css'],
})

export class FetalHeartLinechartComponent implements OnInit {
  ...
  // Fetal Heart API
  LoadFetalHeartRateData(baseview: BaseChartViewModel) {
    this.chartinputservice.GetFetalHeartRateAnalytics(baseview).subscribe(data => {
