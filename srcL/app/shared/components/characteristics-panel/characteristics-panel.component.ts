...
import { CharacteristicsComponent } from '../modal-content/characteristics/characteristics.component';
@Component({
  selector: 'app-characteristics-panel',
  templateUrl: './characteristics-panel.component.html',
  styleUrls: ['./characteristics-panel.component.css']
})
export class CharacteristicsPanelComponent implements OnInit {
