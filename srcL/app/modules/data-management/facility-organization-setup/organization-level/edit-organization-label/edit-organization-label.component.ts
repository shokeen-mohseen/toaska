...
@Component({
  selector: 'app-edit-organization-label',
  templateUrl: './edit-organization-label.component.html',
  styleUrls: ['./edit-organization-label.component.css']
})
export class EditOrganizationLabelComponent implements OnInit {
