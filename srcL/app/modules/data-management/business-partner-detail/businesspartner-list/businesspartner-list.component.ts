...
*/
  ...
  displayedColumnsReplace = ['selectRow', 'key_Businesspartner', 'key_Group', 'key_BillingEntity', 'key_BusinessPartnerName', 'key_Citystate', 'key_BusinessPartnerCode', 'key_MASInventoryWarehouse', 'key_Status', 'key_SetupDone', 'key_Setupdate', 'key_Lastupdated'];
