...
export class OperatingListComponent implements OnInit {
  ...
  displayedColumnsReplace = ['selectRow', 'key_Function', 'key_Group', 'key_BillingEntity', 'key_LocationDescription', 'key_Citystate', 'key_MASInventoryWarehouse',  'key_Status', 'key_SetupDone', 'key_Setupdate', 'key_Lastupdated'];
