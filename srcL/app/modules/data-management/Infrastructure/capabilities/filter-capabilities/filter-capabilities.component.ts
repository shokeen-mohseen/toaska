...
@Component({
  selector: 'app-filter-capabilities',
  templateUrl: './filter-capabilities.component.html',
  styleUrls: ['./filter-capabilities.component.css']
})
export class FilterCapabilitiesComponent implements OnInit {
