...
@Component({
  selector: 'app-add-manageorganization',
  templateUrl: './add-manageorganization.component.html',
  styleUrls: ['./add-manageorganization.component.css']
})
export class AddManageorganizationComponent implements OnInit {
