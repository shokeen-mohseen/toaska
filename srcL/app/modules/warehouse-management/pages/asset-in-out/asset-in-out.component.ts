...
@Component({
  selector: 'app-asset-in-out',
  templateUrl: './asset-in-out.component.html',
  styleUrls: ['./asset-in-out.component.css']
})
export class AssetInOutComponent implements OnInit, AfterViewInit {
