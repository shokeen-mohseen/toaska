...
@Component({
  selector: 'app-atpprocessing',
  templateUrl: './atpprocessing.component.html',
  styleUrls: ['./atpprocessing.component.css']
})
export class ATPProcessingComponent implements OnInit, AfterViewInit {
