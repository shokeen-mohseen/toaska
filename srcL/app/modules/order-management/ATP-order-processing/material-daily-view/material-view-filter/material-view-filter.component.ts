...
@Component({
  selector: 'app-material-view-filter',
  templateUrl: './material-view-filter.component.html',
  styleUrls: ['./material-view-filter.component.css']
})
export class MaterialViewFilterComponent implements OnInit {
