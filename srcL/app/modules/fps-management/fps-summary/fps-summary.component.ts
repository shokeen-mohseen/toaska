...
@Component({
  selector: 'app-fps-summary',
  templateUrl: './fps-summary.component.html',
  styleUrls: ['./fps-summary.component.css']
})
export class FpsSummaryComponent implements OnInit, AfterViewInit {
